        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (imageUri != null){
                    ...
                    DataSource.posts.add(0, new PostModel(capt, "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTnGS_mYRC_KzoWD9n4ItKxseosuGrT9N8wGgVxObTaQNLrAUGr",
                            "ekahanny", "Eka Hanny Oktavia", imageUri));

                    Bundle bundle = new Bundle();
                    bundle.putParcelableArrayList("POSTS", DataSource.posts);
