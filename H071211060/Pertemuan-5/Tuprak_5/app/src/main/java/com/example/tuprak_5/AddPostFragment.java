    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imagePicker.launch(Intent.createChooser(imagePickerIntent,"Pilih ki"));
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (imageUri != null){
                    ...
                    getParentFragmentManager()
                            ...
                            .commit();
                    Toast.makeText(getContext(), "Tawwa berhasil mi diposting", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(getContext(), "Tabe, Pilih ki dulu foto", Toast.LENGTH_SHORT).show();
                }
