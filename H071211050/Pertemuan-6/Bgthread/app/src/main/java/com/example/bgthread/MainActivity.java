...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SearchFragment searchUserFragment = new SearchFragment();
        AddFragment addFragment = new AddFragment();
        ProfileFragment profileFragment = new ProfileFragment();
        Fragment fragment1 = fm.findFragmentByTag(HomeFragment.class.getSimpleName());
        Fragment fragment2 = fm.findFragmentByTag(SearchFragment.class.getSimpleName());
        Fragment fragment3 = fm.findFragmentByTag(AddFragment.class.getSimpleName());
